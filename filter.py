...
def filter_english_news(input_files=['Datasets/Health_News/Health_News.csv', 'Datasets/Covid_and_Vaccine_News/Covid_and_Vaccine_News.csv']):
    try:
        all_english_news = []
        total_records = 0
        ...
        output_file = 'combined_english_news.csv'
